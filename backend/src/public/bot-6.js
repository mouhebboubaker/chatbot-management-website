  ...
  async function sendMessage() {
    ...
    try {
      ...
      const res = await fetch("https://localhost:3000/bots/6/publish", {
        method: "POST",
  ...
  setTheme({
    ...
    "--border-radius": "medium", /* 'large' → mapped to px */
    "--font-size": "moyenne", /* 'grande' */
    "--typing-animation": "points_rebond", /* Just a label, JS/CSS will implement */

    "--launcher-icon": "chat_icon.svg",
  });
});
