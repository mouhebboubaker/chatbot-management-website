  ...
  async function sendMessage() {
    ...
    try {
      ...
      const res = await fetch("http://localhost:3000/chat/8", {
        method: "POST",
  ...
  setTheme({
    ...
    "--border-radius": "small", /* 'large' → mapped to px */
    "--font-size": "petite", /* 'grande' */
    "--typing-animation": "points_pulsants", /* Just a label, JS/CSS will implement */

    "--launcher-icon": "bank_icon.svg",
  });
});
